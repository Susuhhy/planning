...
export default function Home() {
  ...
  // Safe destructuring with fallbacks to prevent crash on old stored data
  const createRoom = store.createRoom;
  const joinRoom = store.joinRoom;
  const rooms = store.rooms ?? [];
  const joinedRooms = store.joinedRooms ?? [];
  const switchRoom = store.switchRoom;
